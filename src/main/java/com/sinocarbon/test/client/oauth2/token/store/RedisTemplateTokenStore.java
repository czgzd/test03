package com.sinocarbon.test.client.oauth2.token.store;
...
import com.sinocarbon.test.client.oauth2.service.RedisClientDetailsService;
...
public class RedisTemplateTokenStore implements TokenStore {
	...
	public OAuth2AccessToken getAuthAccessToken(OAuth2Authentication authentication) {
		String key = authenticationKeyGenerator.extractKey(authentication);
		OAuth2AccessToken accessToken = (OAuth2AccessToken) redisTemplate.opsForValue().get(AUTH_TO_ACCESS + key);
		return accessToken;
	}
	...
	public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
		OAuth2AccessToken existingAccessToken = this.getAuthAccessToken(authentication);
